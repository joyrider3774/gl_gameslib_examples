...
SRC += buildsupport/playdate/setup.c
...
all: device_bin simulator_bin
	$(PDC) $(PDCFLAGS) ${GAME_SOURCE_DIR_NORMALIZED}/Source $(PRODUCT)
...
device_bin: $(OBJDIR)/pdex.elf
	cp $(OBJDIR)/pdex.elf ${GAME_SOURCE_DIR_NORMALIZED}/Source

simulator_bin: $(OBJDIR)/pdex.${DYLIB_EXT}
	cp $(OBJDIR)/pdex.${DYLIB_EXT} ${GAME_SOURCE_DIR_NORMALIZED}/Source
...
clean:
	-rm -rf $(OBJDIR)
	-rm -fR $(PRODUCT)
	-rm -fR ${GAME_SOURCE_DIR_NORMALIZED}/Source/pdex.bin
	-rm -fR ${GAME_SOURCE_DIR_NORMALIZED}/Source/pdex.dylib
	-rm -fR ${GAME_SOURCE_DIR_NORMALIZED}/Source/pdex.so
	-rm -fR ${GAME_SOURCE_DIR_NORMALIZED}/Source/pdex.dll
	-rm -fR ${GAME_SOURCE_DIR_NORMALIZED}/Source/pdex.elf
#
